...
public final class TableCollapsedBorderCellAssigner {

  private TableCollapsedBorderCellAssigner() {}
  
  public static void assignCellBorders(
    ...
    for (int y = 0; y < cell.height(); y++) {
      for (int x = 0; x < cell.width(); x++) {
        assignSlotCellBorders(slotGrid, x, y, cell, borders);
      }
    }

    unifyCellBordersForLayout(slotGrid, cell, borders);
  }
  ...
  private static void unifyCellBordersForLayout(
    TableComputedBorders[][] slotGrid,
  ...
  private static void assignSlotCellBorders(
    TableComputedBorders[][] slotGrid,
    int x, int y,
    TableCell cell,
    TableComputedBorders borders
  ) {
    TableComputedBorders slot = slotGrid[y + cell.cellY()][x + cell.cellX()];

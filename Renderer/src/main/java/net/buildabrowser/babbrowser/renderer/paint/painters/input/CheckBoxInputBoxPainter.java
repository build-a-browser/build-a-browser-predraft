...
import net.buildabrowser.babbrowser.renderer.fragment.input.CheckBoxInputFragment;
...
public class CheckBoxInputBoxPainter implements BoxPainter<CheckBoxInputFragment> {

  @Override
  public void paint(
    CheckBoxInputFragment fragment,
    PaintCanvas canvas,
    ...
    canvas.withPaint(
      ...
      p -> p.drawBox(posX, posY, size, size));
    ...
    if (inputElement.checked()) {
      canvas.withPaint(
        ...
        p -> p.drawBox(
          posX + innerPosOffset, posY + innerPosOffset,
          innerSize, innerSize));
    }
  }

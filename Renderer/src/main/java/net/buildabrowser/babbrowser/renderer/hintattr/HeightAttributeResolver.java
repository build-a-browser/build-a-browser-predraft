...
public final class HeightAttributeResolver {
  ...
  private static final Set<String> ALLOWED_ELEMENTS = Set.of(
    "img", "thead", "tbody", "tfoot");
  private static final Set<String> ALLOWED_ELEMENTS_NONZERO = Set.of(
    "table", "td", "th");
  
  private HeightAttributeResolver() {}

  public static PresentationalHint resolveHeightAttribute(

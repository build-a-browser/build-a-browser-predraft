...
public class GridParser implements PropertyValueParser {
  ...
  private CSSValue parseTemplate(SeekableCSSTokenStream stream) throws IOException {
  ...
  private CSSValue parseRowsThenAutoColumns(SeekableCSSTokenStream stream) throws IOException {
  ...
  private CSSValue parseAutoRowsThenColumns(SeekableCSSTokenStream stream) throws IOException {
    CSSValue autoFlowResult = parseAutoFlowOrDense(stream);
    boolean isDense = autoFlowResult != null;
    if (isDense && autoFlowResult.isFailure()) return autoFlowResult;
  ...
  private CSSValue parseAutoFlowOrDense(SeekableCSSTokenStream stream) throws IOException {

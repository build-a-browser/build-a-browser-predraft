...
public class CustomPropertyParserTest {
  ...
  public void customPropertyValueIsValidForEmptyValue() {
  ...
  public void customPropertyValueIsValidForTypicalValue() {
    List<Token> tokens = List.of(
  ...
  public void customPropertyValueIsNotValidForValueWithUnbalancedRightParantheses() {
    List<Token> tokens = List.of(
      RParenToken.create()
    );
    boolean isValid = CustomPropertyParser.isValidCustomPropertyValue(tokens, true);
  ...
  public void customPropertyValueIsValidForNestedMatchedBrackets() {
    List<Token> tokens = List.of(
  ...
  public void customPropertyValueIsNotValidForMisnestedBrackets() {
    List<Token> tokens = List.of(
      LSBracketToken.create(),
      LCBracketToken.create(),
      RSBracketToken.create(),
  ...
  public void customPropertyValueValidityCheckIsRecursive() {
    List<Token> tokens = List.of(
  ...
  public void customPropertyValueIsNotValidForValueWithTopLevelExclamation() {
    List<Token> tokens = List.of(
      DelimToken.create('!')
    );
    boolean isValid = CustomPropertyParser.isValidCustomPropertyValue(tokens, true);
  ...
  public void customPropertyValueIsValidForValueWithNestedExclamation() {
    List<Token> tokens = List.of(
  ...
  public void customPropertyValueIsNotValidForValueWithMalformedVarReference() {
    List<Token> tokens = List.of(
  ...
  public void varReferenceIsDetectedWhenPresent() {
    List<Token> tokens = List.of(
  ...
  public void varReferenceIsNotDetectedWhenNotPresent() {
    List<Token> tokens = List.of(
  ...
  public void varReferenceIsDetectedWhenNested() {
    List<Token> tokens = List.of(
  ...
  public void invalidVarReferenceIsReported() {
    List<Token> tokens = List.of(
      new FunctionValue("var", List.of(IdentToken.create("my-var")))
    );
    Boolean isDetected = CustomPropertyParser.hasVarReferences(tokens);
  ...
  public void canResolveSimpleVarReference() {
    ...
    CSSValue resultValue = CustomPropertyParser.resolveVarValues(declaration, refContainer);
  ...
  public void canResolveNestedVarReference() {
    TestPropertyContainer refContainer = new TestPropertyContainer(null);
    refContainer.setCustomProperty(
      "--secret-code", new CSSVarValue(List.of(
        IdentToken.create("CAFEBABE"))));
  ...
  public void canResolveVarReferenceWithVarAndFallback() {
    TestPropertyContainer refContainer = new TestPropertyContainer(null);
    refContainer.setCustomProperty(
      "--secret-code", new CSSVarValue(List.of(
        IdentToken.create("CAFEBABE"))));
  ...
  public void canResolveVarReferenceWithJustFallback() {
    TestPropertyContainer refContainer = new TestPropertyContainer(null);
    Declaration declaration = asDeclaration(
      new FunctionValue("var", List.of(
        IdentToken.create("--secret-code"),
  ...
  public void canResolveInheritedVarReference() {
  ...
  public void cannotResolveInitialVarReference() {
    TestPropertyContainer parentRefContainer = new TestPropertyContainer(null);
    parentRefContainer.setCustomProperty(
      "--secret-code", new CSSVarValue(List.of(
        IdentToken.create("CAFEBABE"))));
  ...
  public void cannotResolveUnspecifiedVarReference() {
    TestPropertyContainer refContainer = new TestPropertyContainer(null);
    Declaration declaration = asDeclaration(
      new FunctionValue("var", List.of(IdentToken.create("--secret-code")))
    );
  ...
  public void canResolveVarReferenceWithVarReference() {
    TestPropertyContainer refContainer = new TestPropertyContainer(null);
    refContainer.setCustomProperty(
  ...
  public void fallsBackOnRecursiveVarReference() {
    TestPropertyContainer refContainer = new TestPropertyContainer(null);
    refContainer.setCustomProperty(
      "--a-name", new CSSVarValue(List.of(
        new FunctionValue("var", List.of(
  ...
  private Declaration asDeclaration(Token... tokens) {
    return Declaration.create("test", List.of(tokens), false);
  }

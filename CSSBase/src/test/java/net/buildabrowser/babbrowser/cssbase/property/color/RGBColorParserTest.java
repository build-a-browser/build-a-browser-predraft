...
public class RGBColorParserTest {
  ...
  public void canParseLegacyWithNumbers() throws IOException {
    ...
    CSSValue result = rgbColorParser.parse(CSSTokenStream.createForTesting(functionValue));
  ...
  public void canNotMixLegacyAndModernSyntax() throws IOException {
    ...
    CSSValue result1 = rgbColorParser.parse(CSSTokenStream.createForTesting(functionValue));
    ...
    CSSValue result2 = rgbColorParser.parse(CSSTokenStream.createForTesting(functionValue));

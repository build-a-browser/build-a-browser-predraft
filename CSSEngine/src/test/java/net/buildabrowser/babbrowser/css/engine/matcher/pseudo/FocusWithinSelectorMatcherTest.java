...
public class FocusWithinSelectorMatcherTest {

  private ElementRootSet allElements;
  private FocusWithinSelectorMatcher matcher;

  @BeforeEach
  public void beforeEach() {
    this.allElements = ElementSet.createRoot();
    this.matcher = new FocusWithinSelectorMatcher(allElements, _1 -> {});
  }
  ...
  public void canMatchFocusedElement() {
    ...
    SimplePseudoSelector selector = SimplePseudoSelector.FOCUS_WITHIN;
  ...
  @Test
  @DisplayName("Parent elements are affected by focus")
  @SuppressWarnings("deprecation")
  public void parentElementsAreAffectedByFocus() {
